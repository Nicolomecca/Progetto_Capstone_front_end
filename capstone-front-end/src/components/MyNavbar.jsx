            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto nav-links">
                        ...
                        <Nav.Link className="nav-item text-white fs-5" onClick={() => setExpanded(false)}>Theory</Nav.Link>
                        <Nav.Link className="nav-item text-white fs-5" onClick={() => setExpanded(false)}>Quiz</Nav.Link>
