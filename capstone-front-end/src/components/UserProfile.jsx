  ...
  return (
    ...
    >
      <Container className="py-5">
        ...
        >
          <Card
            className="profile-card glass-effect"
                ...
                <Col md={7}>
                  ...
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <span className="text-white">
                      Punteggio Totale: {profileData.totalScore}
                    </span>
                  </div>

                  <h5 className="text-white mt-4">
                    <FaCode className="me-2 neon-green-text" />
                    Progressi Linguaggi
                  </h5>
                  <Row className="mb-3">
                    {Object.entries(profileData.languageProgresses).map(
                      ([language, level]) => (
                        <Col
                          key={language}
                          xs={6}
